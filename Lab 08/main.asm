; Lab_06_Task_02.asm
;
; Created: 5/23/2023 1:30:15 PM
; Author : fahim
;

; This assembly code is written for the ATmega328P microcontroller.
; It sets up the data direction registers (DDRs) for two pins on PORTD (0 and 1)
; as outputs.
